...
import { FaLanguage, FaShieldAlt, FaFileExport, FaChartLine } from 'react-icons/fa';
...
export const EnhancedAnalysis: React.FC<EnhancedAnalysisProps> = ({ analysis, onExport }) => {
